...
class SpecialThemeAdd{
  static Color getDoneButtonColor(){
    if(PlistoDynamic.getBrightness()) return PlistoLightTheme.color[1];
    else return PlistoDarkTheme.alt[1];
  }
  ...
  static Color getAppBarContentColor(){
    if(PlistoDynamic.getBrightness()) return PlistoLightTheme.title;
  ...
  static Color getHeadColor(){
    if(PlistoDynamic.getBrightness()) return PlistoLightTheme.subtitle3;
    else return PlistoDarkTheme.cardBackground;

  }
  static Color getHeadIconColor(){
    if(PlistoDynamic.getBrightness()) return PlistoLightTheme.subtitle;
    else return PlistoDarkTheme.title;
